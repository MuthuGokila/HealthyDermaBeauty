    ...
    <div>
      ...
      >
        ...
        <div className="container container-fluid text-center ">
          <h1 style={{fontFamily:"Times New Roman",color: "white", }}className="display-1">
            {FirstName + " " + MiddleName + " " + LastName}
          </h1>
          <Typist style={{fontFamily:"Times New Roman",color: "white", }} className="lead"> {devDesc}</Typist>
          <div className="p-5">
            {icons.map((icon) => (
              <a
                key={icon.id}
          ...
          <a
           style={{textAlign:'center', background:'white',color:'black', fontWeight:'bold'}}

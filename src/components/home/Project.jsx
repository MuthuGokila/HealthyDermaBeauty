  ...
  return (
    <div id="projects" className="jumbotron jumbotron-fluid bg-transparent m-0" >
      {projectsArray.length && (
        <div style={{background:'black'}}className="container-fluid full-width">
          <h1 style={{textAlign:'center', color:'white', fontWeight:'bold'}}className="display-4 pb-5">{projectHeading}</h1>
          <div className="row-fluid header-top">
